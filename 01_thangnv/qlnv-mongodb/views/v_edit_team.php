<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo $_GET['action']=="add"?"ADD Team":"Update Team";?></h2>
            ...
            <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                        ...
                        <input name="id" type="text" readonly="readonly" value="<?php if($action!="add") echo $team->_id; ?>" class="form-control" placeholder="ID">
                    </div>
                    ...
                    <label for="leader_id">Leader ID</label>
                        <select class="form-control" name="leader_id">
                            ...
                            ?>
                            <option <?php if($id->_id==$team->leader_id) echo "selected" ?> value="<?php echo $id->_id ?>"><?php echo $id->name ?></option>
                            <?php
                                }
                            ?>
                        </select>
