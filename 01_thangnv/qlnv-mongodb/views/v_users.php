          ...
          <?php foreach ($users as $user){ 
            ...
            <tr>
              <td class="text-center">
                <a href="index.php?controller=c_edit_user&action=edit&id=<?php echo $user->_id ?>"><i class="fa fa-edit"></i></a>
                &nbsp;
                <a href="index.php?controller=c_edit_user&action=delete&id=<?php echo $user->_id ?>" onclick="return window.confirm('Bạn muốn xóa user <?php echo $user->name ?> ?')"><i class="fa fa-remove"></i></a>
              </td>
              ...
              <td><?php echo $user->info_team[0]->name ?></td>
