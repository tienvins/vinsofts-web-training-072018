            ...
            <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                        ...
                        <input required name="id" type="number" readonly="readonly" value="<?php if($action=="add") echo $new_id; else echo $user->id; ?>" class="form-control" placeholder="ID" value="<?php echo $user->id ?>">
                    </div>
                    ...
                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                        ...
                        <select class="form-control" name="team_id" value="<?php echo $user->team_id ?>">
                            ...
                            ?>
                            <option <?php if($id->id==$user->team_id) echo "selected" ?> value="<?php echo $id->id ?>"><?php echo $id->name ?></option>
                            <?php
                                }
                            ?>
                        </select>
