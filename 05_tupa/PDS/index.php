...
<head>
    ...
    <link rel="stylesheet" href="style/below.css">
    <link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
    <title>Vinsofts</title>
</head>
<style>
    <?php echo file_get_contents("style/above.css"); ?>
</style>
<body>
    <!-- main -->
    <main>
        ...
        <header>
            ...
            <div class="header-left">
                <img src="images/logo.jpg" title="vinsofts" alt="vinsofts" width="94px" height="54px"><br/>
            ...
            <div class="header-right">
                ...
                <nav class="menu">
                    ...
                    <ul class="icon">
                            ...
                            <li><a href="#"><img src="images/in.jpg" alt=""></a></li>
        ...
        <footer>
            ...
            <div class="footer-contact">
                ...
                <div class="line1" style="width:300px;"></div>
