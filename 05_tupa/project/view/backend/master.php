            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="admin.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> User <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin.php?controller=user">View User</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Teams <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin.php?controller=teams">View Teams</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Leader <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin.php?controller=leader">View Leader</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        ...
                        <span class="message">
                          Film festivals used to be do-or-die moments for movie makers. They were wherepublic/backend.
                        </span>
                      </a>
                    </li>
                    <li>
        ...
        <div class="right_col" role="main">
          ...
          <?php  
            if(file_exists($controller))
              ...
              include("controller/backend/controller_aaa.php");
            }
          ?>
        </div>
        <!-- /page content -->
