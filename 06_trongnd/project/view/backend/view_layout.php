...
<html lang="en">
  <head>
    ...
    <link href="public/backend/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
  ...
  <body class="nav-md">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin.php?controller=user">QL USER</a></li>
    ...
    <!-- jQuery custom content scroller -->
    <script src="public/backend/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
