			...
			switch ($action) {
				...
				case "do_add":
		            ...
		            if ($_SERVER["REQUEST_METHOD"] == "POST") {
						$url = 'http://localhost/vinsofts/07_kiendv/PHP_MVC/APIs/api/teamsApi.php/create';
				...
				case "edit":
					...
					$data = $this->model->fetch_one("select * from teams where id = $id");
					$arr = $this->model->fetch("select * from users");
					include "view/backend/viewAddEditTeams.php";
					break;
				case "do_edit":
			        ...
			        if ($_SERVER["REQUEST_METHOD"] == "POST") {
						$url = 'http://localhost/vinsofts/07_kiendv/PHP_MVC/APIs/api/teamsApi.php/update?id='.$id;
