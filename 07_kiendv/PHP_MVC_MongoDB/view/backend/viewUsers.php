  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <a class="showmore" data-toggle="modal" data-target="#<?php echo $row->_id ?>"><span><i class="fas fa-search-plus fa-2x"></i></span></a>&nbsp;
                  <a href="admin.php?controller=AddEditUsers&action=edit&id=<?php echo $row->_id ?>"><span><i class="fas fa-edit fa-2x"></i></span></a>&nbsp;
                  <a href="admin.php?controller=Users&action=delete&id=<?php echo $row->_id ?>"><span><i class="fas fa-trash-alt fa-2x"></i></span></a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
        ...
        ?>
          <div class="modal fade" id="<?php echo $row->_id ?>" role="dialog">
            <div class="modal-dialog">
              <!-- Modal content-->
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Thong tin chi tiet</h4>
                </div>
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    <tbody>
                      <thead>
                            ...
                            Mã nhân viên: <?php echo $row->_id ?></h2>
                      </thead>
                      <tr>
